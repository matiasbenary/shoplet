...
import { activeSearchProvider } from './search.ts'
...
app.post('/api/chat', async (req, res) => {
  ...
  // Trust boundary: locale reaches the configured search provider, so it must be a known key.
...
const PROVIDER_KEYS: Record<string, string> = { serpapi: 'SERPAPI_KEY', brave: 'BRAVE_SEARCH_API_KEY' }
const missing = ['NEAR_AI_API_KEY', PROVIDER_KEYS[activeSearchProvider.name]]
